        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          ...
          {true ? (
            <p className="mt-2 text-base text-muted-foreground">
              Your order was processed and its availiable to download below!
                    ...
                    return <li key={product.id} className="flex space-x-6 py-6">
                        <div className="relative h-24 w-24">
                            {typeof image !== "string" && image.url ? (
                                <Image fill src={image.url} alt={`${product.name} image`} className="flex-none rounded-md bg-gray-100 object-cover"/>
                            ): null}
                        </div>
                        ...
                        <div className="flex-auto flex flex-col justify-between">
                            ...
                            {order._isPaid ? (
                                <a href={downloadUrl} download={product.name} className="text-blue-600 hover:underline underline-offset-2">Download asset.</a>
                            )
